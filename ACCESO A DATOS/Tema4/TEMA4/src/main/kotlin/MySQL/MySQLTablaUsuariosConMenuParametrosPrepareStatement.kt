...
private val url = "jdbc:mysql://172.17.0.2:3306/Gestion"
private val usuari = "root"
private val password = "secret"
private val con = DriverManager.getConnection(url, usuari, password)
...
private fun deleteData(id: Int) {
    try {
        val checkId = "SELECT FROM USUARIOS WHERE id = ?"
