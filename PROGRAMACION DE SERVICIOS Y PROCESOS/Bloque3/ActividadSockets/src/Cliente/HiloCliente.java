...
public class HiloCliente extends JFrame implements ActionListener, Runnable {
	...
	// constructor
	public HiloCliente (Socket s, String nombre) {
	...
	public static void main(String args[]) {
		...
		if (!nombre.trim().equals("")) {
			HiloCliente  cliente = new HiloCliente (s, nombre);
